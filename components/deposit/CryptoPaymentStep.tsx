...
const CryptoPaymentStep: React.FC<CryptoPaymentStepProps> = ({
  ...
  return (
    <div className="pt-6 px-4 flex flex-col min-h-0 overflow-y-auto">
      <div className="rounded-xl overflow-hidden mb-3 shrink-0 bg-surfaceElevated">
        <div className="px-4 py-5 flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full overflow-hidden flex items-center justify-center mb-3 bg-background/40">
      ...
      <div className="flex items-start gap-2 px-3 py-2.5 rounded-xl mb-3 shrink-0 bg-surfaceElevated">
